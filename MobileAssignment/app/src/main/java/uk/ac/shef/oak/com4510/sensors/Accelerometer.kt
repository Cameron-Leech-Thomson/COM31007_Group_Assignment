...
class Accelerometer(context: Context, controller: SensorsController, barometer: Barometer,
                    thermometer: Thermometer, hygrometer: Hygrometer) {
    ...
    private val hygrometer: Hygrometer
    ...
    init {
        ...
        sensorEventListener = object : SensorEventListener {
            ...
            override fun onSensorChanged(event: SensorEvent) {
                ...
                val timeString = controller.mSecsToString(actualTimeInMseconds)
